function kits() {
    return (
        <div className="p-3 md:px-28 md:py-8">
            <h2 className="text-xl md:text-4xl font-bold text-center leading-relaxedpy-3">Build Your Own AI Launchpad Kit: Empowering Innovation and Learning</h2>
            ...
            <p className="p-1 text-lg text-center">11/24/20243 min read</p>
            <img src="/assets/images/ai-landing.avif" alt="img" className="w-[100%] p-2 mx-auto md:w-[55%]"></img>
            <p className="py-5 text-lg text-center">Here’s an expanded version of the article with additional sections, FAQs, and pricing details in PKR.</p>
            <h2 className="text-2xl font-bold px-2 md:text-5xl md:px-5 ">Build Your Own AI Launchpad Kit: Empowering Innovation and Learning</h2>
            <p className="text-lg leading-relaxed py-3 md:p-6">Welcome to the world of hands-on AI and STEM exploration! Our AI Launchpad Kit is designed to make learning artificial intelligence, IoT, and robotics accessible, engaging, and impactful. Whether you prefer purchasing a complete kit or assembling your own using components from the market, we provide everything you need to get started: detailed manuals, step-by-step guides, and instructional videos—all available on our website.</p>
            <h2 className="text-2xl font-bold px-2 md:text-5xl md:px-5 ">Option 1: Assemble Your Own AI Launchpad Kit</h2>
            <p className="text-lg leading-relaxed py-3 md:p-6">For DIY enthusiasts, here’s a bare minimum component list to help you create your AI Launchpad Kit. These items are affordable and easily available in local electronics markets or online stores.</p>

            <h2 className="text-2xl font-bold px-2 md:text-5xl md:px-5 ">Bare Minimum Component List</h2>
            ...
            {/* Option 2: */}
            <h2 className="text-5xl py-5 leading-tight font-bold">Option 2: Purchase the Complete AI Launchpad Kit</h2>
            <p className="text-lg">For those seeking convenience and advanced capabilities, the Complete AI Launchpad Kit is a ready-to-use package. It includes all the bare minimum components plus additional tools for advanced AI, IoT, and robotics projects.</p>
            <h2 className="text-5xl py-5 leading-tight font-bold">Full Kit Component List</h2>
            ...
            <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold"> </span> <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold">. </span>Relay Module 300 – 500 Light Dependent Resistor (LDR) 100 – 200 </p>
                <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold">. </span>IR Receiver Module 300 – 400 </p>
                <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold">. </span>Complete Kit Price: PKR 12,000 – 15,000 </p>
                <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold">. </span>With the full kit, you can build advanced projects like:</p>
            </p>
            ...
            <p className="text-lg px-2 md:px-5 leading-relaxed"><span className="text-lg font-bold">. </span>Environmental monitoring stations.</p>
            <h2 className="text-2xl md:text-5xl font-bold p-3">FAQS</h2>
            <h3 className="text-xl md:text-3xl font-bold pt-4">1. What if I’m new to AI and coding?</h3>
            <p className="text-lg leading-normal p-2">No worries! Our website offers detailed manuals, beginner-friendly guides, and video tutorials to help you get started, even if you have no prior experience.</p>

            <h3 className="text-xl md:text-3xl font-bold pt-4">2. Can I buy individual components from your website?</h3>
            <p className="text-lg leading-normal p-2">Currently, we don’t sell individual components, but our platform guides you on how to source them locally or online.</p>

            <h3 className="text-xl md:text-3xl font-bold pt-4">3. What kind of projects can I build?</h3>
            <p className="text-lg leading-normal p-2"> What kind of projects can I build?</p>
            ...
            <h3 className="text-xl md:text-3xl font-bold pt-4">4. Is this kit suitable for schools or STEM clubs?</h3>
            <p className="text-lg leading-normal p-2">Absolutely! The kit is ideal for educators, STEM clubs, and workshops. We also offer bulk discounts for educational institutions.</p>

            <h3 className="text-xl md:text-3xl font-bold pt-4">5. Are the resources free?</h3>
            <p className="text-lg leading-normal p-2">Yes! All manuals, guides, and video tutorials are freely available on our website for registered users.</p>

            <h3 className="text-xl md:text-3xl font-bold pt-4">6. Can I upgrade my kit later?</h3>
            <p className="text-lg leading-normal p-2">Yes, you can start with the basic components and add advanced items like the ESP32-CAM or servo motors later.</p>


            <h3 className="text-xl md:text-3xl font-bold pt-4">Pricing Details</h3>
            <p className="text-lg leading-normal p-2"><span className="font-bold">Kit Option Price (PKR)</span> Bare Minimum DIY Kit (assembled by you) Approx. PKR 5,000 – 7,500 Complete AI Launchpad Kit PKR 12,000 – 15,000</p>
            <p className="text-lg">Note: Prices may vary slightly based on market rates and availability.</p>


            <h3 className="text-xl md:text-3xl font-bold pt-4">Why Choose Our Platform?</h3>
            ...
            <p className="text-lg font-bold">Start your journey today and unleash the power of AI and STEM learning with the AI Launchpad Kit! </p>
