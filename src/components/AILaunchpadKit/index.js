function ownaiLaunchpadKit() {
    return (
        <div className="p-3 py-4 md:py-16 md:px-56">
            <h2 className="text-2xl md:text-5xl font-bold text-center py-3 md:py-6">Build Your Own AI Launchpad Kit: Empowering Innovation and Learning</h2>
            ...
            <div className="col-span-1 py-3">
                <img src="\assets\images\Iot 01.avif" alt="img" className="md:w-[75%] w-[100%] mx-auto h-[280px] object-fill"></img>
            </div>
            <p className="py-2 text-lg">Here’s an expanded version of the article with additional sections, FAQs, and pricing details in PKR.</p>
            <h3 className="text-3xl py-3 md:py-6 font-bold md:text-6xl">Build Your Own AI Launchpad Kit: Empowering Innovation and Learning</h3>
            <p className="text-lg">Welcome to the world of hands-on AI and STEM exploration! Our <span className="font-bold">AI Launchpad Kit</span> is designed to make learning artificial intelligence, IoT, and robotics accessible, engaging, and impactful. Whether you prefer purchasing a complete kit or assembling your own using components from the market, we provide everything you need to get started: detailed manuals, step-by-step guides, and instructional videos—all available on our website.</p>
            <h3 className="text-2xl font-bold md:text-5xl py-3 md:py-6">Option 1: Assemble Your Own AI Launchpad Kit</h3>
            <p className="text-lg">For DIY enthusiasts, here’s a <span className="font-bold">bare minimum component list</span> to help you create your AI Launchpad Kit. These items are affordable and easily available in local electronics markets or online stores.</p>
            <h3 className="text-2xl py-3 md:py-5 md:text-4xl font-bold">Bare Minimum Component List</h3>
            ...
            <h2 className="text-2xl font-bold md:text-5xl py-3 md:py-6">Option 2: Purchase the Complete AI Launchpad Kit</h2>
            ...
            <h3 className="text-2xl py-3 md:py-5 md:text-4xl font-bold">Full Kit Component List</h3>
            ...
            <h3 className="text-2xl py-2 md:py-3 md:text-4xl font-bold">FAQS</h3>

            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">1. What if I’m new to AI and coding?</h3>
            <p className="text-lg leading-relaxed pb-3">No worries! Our website offers detailed manuals, beginner-friendly guides, and video tutorials to help you get started, even if you have no prior experience.</p>

            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">2. Can I buy individual components from your website?</h3>
            <p className="text-lg leading-relaxed pb-3">Currently, we don’t sell individual components, but our platform guides you on how to source them locally or online.</p>

            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">3. What kind of projects can I build?</h3>
            <p className="text-lg leading-relaxed pb-3">With the AI Launchpad Kit, you can create projects like:</p>
            ...
            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">4. Is this kit suitable for schools or STEM clubs?</h3>
            <p className="text-lg leading-relaxed pb-3">Absolutely! The kit is ideal for educators, STEM clubs, and workshops. We also offer bulk discounts for educational institutions.</p>


            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">5. Are the resources free?</h3>
            <p className="text-lg leading-relaxed pb-3">Yes! All manuals, guides, and video tutorials are freely available on our website for registered users.</p>

            <h3 className="text-xl py-2 md:py-3 md:text-3xl font-bold">6. Can I upgrade my kit later?</h3>
            <p className="text-lg leading-relaxed pb-3">Yes, you can start with the basic components and add advanced items like the ESP32-CAM or servo motors later.</p>


            <h3 className="text-2xl py-2 md:py-3 md:text-4xl font-bold">Pricing Details</h3>
            ...
            <h3 className="text-2xl py-2 md:py-3 md:text-4xl font-bold">Why Choose Our Platform?</h3>
            ...
            <p className="text-lg leading-relaxed font-bold">Start your journey today and unleash the power of AI and STEM learning with the AI Launchpad Kit! </p>
